...
export const translations = {
  en: {
    ...
    errorVeoKeyNotFound: 'Video generation failed. The API key was not found or has expired. Please <a href="https://aistudio.google.com/app/u/1/apikey" target="_blank" rel="noopener noreferrer" class="font-semibold underline hover:text-red-800 dark:hover:text-red-300">select your key</a> again. This may also happen if your project does not have billing enabled.',
    ...
    uploadVisual: 'Upload',
    removeButton: 'Remove',
    generateImageButton: 'Image',
    generateVideoButton: 'Video',
    ...
    suggestDesignButton: 'Suggest Design with AI',
    suggestingDesignMessage: 'Analyzing your topic to suggest a design...',
    refineImagePrompt: 'Refine Image',
  ...
  id: {
    ...
    signUpSubtitle: 'Selamat datang! Silakan isi detail untuk memulai.',
    signInTitle: 'Masuk ke akun Anda',
    signInSubtitle: 'Selamat datang kembali! Silakan masukkan detail Anda.',
    ...
    errorVeoKeyNotFound: 'Gagal membuat video. Kunci API tidak ditemukan atau kedaluwarsa. Silakan <a href="https://aistudio.google.com/app/u/1/apikey" target="_blank" rel="noopener noreferrer" class="font-semibold underline hover:text-red-800 dark:hover:text-red-300">pilih kunci Anda</a> lagi. Ini juga bisa terjadi jika proyek Anda belum mengaktifkan penagihan.',
    generatingContentMessage: 'Menyusun konten carousel Anda...',
    generatingImageMessage: 'Menghasilkan gambar {{current}} dari {{total}}...',
    generatingVideoMessage: 'Membuat video... ini mungkin memakan waktu beberapa menit.',
    applyTo: 'Terapkan ke:',
    applyToAll: 'Semua Slide',
    applyToSelected: 'Slide Terpilih',
    uploadVisual: 'Unggah',
    removeButton: 'Hapus',
    generateImageButton: 'Gambar',
    generateVideoButton: 'Video',
    ...
    suggestDesignButton: 'Sarankan Desain (AI)',
    suggestingDesignMessage: 'Menganalisis topik Anda untuk menyarankan desain...',
