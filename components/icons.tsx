...
export const LogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M22.0002 0L0 11V33L22.0002 44L44.0005 33V11L22.0002 0Z" fill="#00C2CB"/>
        <path d="M22.0002 22L0 11L22.0002 0L44.0005 11L22.0002 22Z" fill="#42e8f8" fillOpacity={0.8}/>
        <path d="M0 11V33L22.0002 44V22L0 11Z" fill="#007f88"/>
    </svg>
);

export const EyeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639l4.418-5.571a1.012 1.012 0 0 1 1.284 0l4.418 5.571a1.012 1.012 0 0 1 0 .639l-4.418 5.571a1.012 1.012 0 0 1-1.284 0l-4.418-5.571Z" />
